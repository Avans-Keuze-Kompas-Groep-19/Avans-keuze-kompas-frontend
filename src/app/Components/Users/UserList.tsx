                ...
                {users.map((user) => (
                    <div key={user._id} className="border p-4 rounded-lg shadow">
                        ...
                        <div className="mt-4 flex gap-2">
                            <button onClick={() => handleEditClick(user)} className="px-4 py-2 bg-blue-500 text-white rounded">Edit</button>
                            <button onClick={() => handleDeleteClick(user)} className="px-4 py-2 bg-red-600 text-white rounded">Delete</button>
                        </div>
                    </div>
                ))}
            </div>
